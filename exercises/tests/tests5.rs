...
unsafe fn modify_by_address(address: usize) {
    // SAFETY: 
    // - The caller guarantees the address points to a valid mutable u32
    // - We're performing a properly aligned write to the location
    // - The caller ensures exclusive access to this memory
    unsafe {
